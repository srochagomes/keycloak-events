...
data class UserEntityEvent(
    @Id @Column(name = "ID_KEY") var id : UUID,
    @Temporal(TemporalType.TIMESTAMP) @Column(name = "DT_HR_CREATED")
    @JsonSerialize(`as` = Date::class)
    @JsonFormat(pattern="yyyy-MM-dd'T'HH:mm:ss.SSSSSS", timezone = "America/Sao_Paulo") var createAt : LocalDateTime,
